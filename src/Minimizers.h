...
class LeastSquareError
{
    ...
    public:
        ...
        void initialize(int SampleId, vector<HaplotypeSet> &InputData,
...
void LeastSquareError::initialize(int SampleId, vector<HaplotypeSet> &InputData,
                                    MetaMinimac *const ThisStudy,ThisChunk &MyChunk)
{
...
void LogOddsModel::initialize(int SampleId, vector<HaplotypeSet> &InputData,
                                    MetaMinimac *const ThisStudy,ThisChunk &MyChunk)
{
...
void LeastSquareWithRecombination::initialize(int SampleId, vector<HaplotypeSet> &InputData,
                                    MetaMinimac *const ThisStudy,ThisChunk &MyChunk)
{
